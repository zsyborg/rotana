                      ...
                      <article className="sc-53f348b9-5 bCwIwB dynamic-elearning-content--description">
                        <div className="sc-213d61b3-0 kexixH">
                          <div>
                            ...
                            <p className="sc-2cb50690-7 isiQyk">Umrah is an act of worshipping Allah by entering the
                              state
                              of Ihram, circumambulating the House, running between Safa and Marwa, and having the head
                              shaved or trimmed.</p>
                            <h3 className="sc-2cb50690-7 isiQyk"><strong>How do I enter into the state of
                                Ihram?</strong></h3>
                            <ul>
                            ...
                            <h3 className="sc-2cb50690-7 isiQyk"><strong>Having hair of the head shaven or
                                trimmed:</strong>
                            </h3>
                            <ul>
                            ...
                            <p className="sc-2cb50690-7 isiQyk">Umrah pilgrims should avoid any conduct that harms
                              others in
                ...
                <div className="sc-53f348b9-1 fgPYfX">
                  <div className="sc-53f348b9-2 jJuIle">
                    <article className="sc-53f348b9-5 bCwIwB dynamic-elearning-content--description">
                      <div className="sc-213d61b3-0 kexixH">
                        <div className="">
                          <h3 className="islamiccolor"><strong>Performing Umrah in Ramadan</strong></h3>
                          <p className="sc-2cb50690-7 isiQyk">Umrah has great virtues at all times. It is one of the
                            deeds
                            that expiate sins, for the Prophet (blessings and peace be upon him) said. Additionally, it
                            has a special virtue during Ramadan.</p>
                          <h3 className="sc-2cb50690-7 isiQyk"><strong>Reward for performing Umrah in Ramadan</strong>
                          </h3>
                          <ul>
                            <li>The Prophet blessings and peace be upon him said: "Performance of Umrah in Ramadan is
                              equivalent to Hajj", or he said: "Equal to performance of Hajj with me"</li>
                            <li>This virtue extends to all the days and nights of Ramadan</li>
                            <li>The pilgrim must perform his Umrah at the time allotted to him as shown by the
                              reservations in the official Umrah applications</li>
                          </ul>
                          <p className="sc-2cb50690-7 isiQyk">When you drive for Umrah, park your car in a parking lot
                            in
                            Makkah.</p>
                        </div>
                      </div>
                  ...
                  <div className="sc-53f348b9-1 fgPYfX">
                    <div className="sc-53f348b9-2 jJuIle">
                      <article className="sc-53f348b9-5 bCwIwB dynamic-elearning-content--description">
                        <div className="sc-213d61b3-0 kexixH">
                          <div>
                            <h3 className="sc-2cb50690-7 isiQyk"><strong>Performing more than one Umrah during the same
                                trip</strong></h3>
                            <ul>
                              <li>Performing the Umrah is one of the best and greatest deeds in the sight of Allah, as
                                the Prophet (blessings and peace be upon him) said: "The performance of one Umrah is an
                                expiation for what was committed between it and the previous. And it is allowed to
                                repeat more than once per year".</li>
                            </ul>
                            <p className="sc-2cb50690-7 isiQyk"><strong>Is it prescribed to perform more than one Umrah
                                during the same trip?</strong></p>
                            <ul>
                              <li>Some visitors to Makkah are keen to repeat Umrah on behalf of themselves or some of
                                their relatives, for fear that they won't be able to visit Makkah again. This is
                                permissible unless it causes inconvenience to other pilgrims or it violates the terms
                                and conditions of Umrah's official applications.</li>
                              <li>Once one obtains the necessary permission of the concerned bodies to perform another
                                Umrah shall go to the nearest place outside the Haram, such as the mosque of Aishah (may
                                Allah be pleased with her) in Al Taneem. He/she enters into the state of Ihram from this
                                place, then performs the Umrah.</li>
                            </ul>
                          </div>
                        </div>
                      </article>
            ...
            <div className="col-lg-4 col-sm-12">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-txt">Jabal al-Nour (Arabic: جَبَل ٱلنُّوْر, romanized: Jabal an-Nūr, lit. 'Mountain
                    of
                    the Light' or 'Hill of the Illumination') is a mountain near Mecca in the Hejaz region of Saudi
                    Arabia.[1] The mountain houses the grotto or cave of Hira' (Arabic: غَار حِرَاء, romanized:
                    Ghar-i-Hira, lit. 'Cave of Hira'), which holds tremendous significance for Muslims throughout the
                    world. </p>
            ...
            <div className="col-lg-4 col-sm-12">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-txt">Jabal Thawr (Arabic: جَبَل ثَوْر) is a mountain in Saudi Arabia, located in
                    the
                    lower part of Mecca to the south of the district of Misfalah.[1] The height of the mountain is 750 m
                    (2,460 ft). Prophet Muhammad took refuge from the Quraysh, during the migration to Medina. Mount
                    Thawr is located 5 miles (8.0 kilometres) away from Mecca. In Sunni Islam, it is believed that
                    Muhammad stayed here as a refugee with his companion Abu Bakr. </p>
            ...
            <div className="col-lg-4 col-sm-12">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-txt">The Clock Towers (Arabic: أبراج الساعة, romanized: Abrāj al-Sāʿa, lit. 'Towers
                    of
                    the Clock', formerly known as Abraj Al Bait), is a government-owned complex of seven skyscraper
                    hotels in Mecca, Saudi Arabia. These towers are a part of the King Abdulaziz Endowment Project that
                    aims to modernize the city in catering to its pilgrims. </p>
            ...
            <div className="col-lg-4 col-sm-12">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-txt">The Zamzam Well (Arabic: بئر زمزم, romanized: Biʾru Zamzam Arabic
                    pronunciation:
                    [biʔru zam.zam]) is a well located within the Masjid al-Haram in Mecca, Saudi Arabia. It is located
                    20 m (66 ft) east of the Kaaba,[2] the holiest place in Islam. </p>
            ...
            <div className="col-lg-4 col-sm-12">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-txt">New black, pure-silk clothing for Kaaba, called kiswa, is made by the Kiswa
                    Factory of the Holy Kaaba (King Abdulaziz Complex) every year. It is embroidered with silver wires
                    painted with glittering gold, with which Quranic verses and supplications are written. The clothing
                    is used to cover "The Ancient House" (another name for Kaaba) to which Muslims' hearts are attached.
                  </p>
            ...
            <div className="col-lg-4 col-sm-12">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-txt">Taif is indirectly referred to in Quran 43:31.[3] The city was visited by the
                    Islamic prophet Muhammad, sometime in the early 7th century, and was inhabited by the tribe of Banu
                    Thaqif. It is still inhabited to this day by their descendants. As a part of the Hejaz, the city has
                    seen many transfers-of-power throughout its history, with the last being during the Saudi conquest
                    of Hejaz in 1925. </p>
            ...
            <div className="col-lg-6 col-sm-12">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-txt">Badr (Arabic: بَـدْر, full name: Badr Hunayn, Arabic: بدر حنین) is a town in
                    Al
                    Madinah Province, Al-Hijaz, Saudi Arabia. It is located about 130 km (81 mi) from Madina. It was the
                    location of the Battle of Badr, between the Quraishi-led polytheists, and the Muslims under the
                    leadership of Muhammad,[1] in 624 CE. the Battle occurred when 313 men encountered outnumbering
                    Meccan forces of the pagan Quraish army. The result was a victory for the Muslims under the command
                    of Muhammad, the last prophet of Islam. </p>
